...
// names.benchmarks.categories.load = {name: 'load', sort_index:14 };
...
names.benchmarks.categories.all = [//14
	...
	names.benchmarks.categories.input,		//6
	names.benchmarks.categories.edit,		//7
	names.benchmarks.categories.select,		//8
	names.benchmarks.categories.remove,		//9
	names.benchmarks.categories.filter,		//10
	names.benchmarks.categories.search,		//11
	names.benchmarks.categories.memory,		//12
	// names.benchmarks.categories.load,		//3
];
